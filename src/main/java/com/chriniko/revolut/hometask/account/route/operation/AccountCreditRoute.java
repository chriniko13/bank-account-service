...
@Dependent
public class AccountCreditRoute extends AccountRouteDefinition {

    private final AccountService accountService;

    @Inject
    protected AccountCreditRoute(@UtcZone Clock clock,
    ...
    @Override
    public String url() {
        return "/accounts/{accountId}/credit";
    }
        ...
        HttpHandler handler = httpHandler(x -> {
            ...
            x.getRequestReceiver().receiveFullBytes(
                    (_exchange, message) -> {
                        ...
                        accountService.credit(accountId, request, optimisticReadStamp);
